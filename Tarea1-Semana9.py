...
TOKEN = '1900060590:AAFyPrajTG2OVicOyh0gyM-31sg8av1HH6s'
...
def command_start(m):
    ...
    if cid not in knownUsers: 
        ...
        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
        bot.send_message(cid, "Saludos Usuario .")

        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
        bot.send_message(cid, "que tal te va")
        ...
        bot.send_chat_action(cid, 'typing')
        time.sleep(3)
        bot.send_message(cid, "mis instruciones son estas mostrarte las siguientes conversiones")
